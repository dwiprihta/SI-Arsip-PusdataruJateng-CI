...
<div class="container-fluid">
 ...
 <nav aria-label="breadcrumb">
            ...
            <ol class="breadcrumb bg-white">
              ...
              <li class="breadcrumb-item active" aria-current="page">Detil arsip dokumen Pensiun</li>
              ...
              <div class="card shadow mb-4">
                      ...
                      <div class="card-header py-3">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-6">
                            ...
                            <h6 class="m-0 font-weight-bold text-primary"><I class="fa fa-user"></i> DETAIL ARSIP PEGAWAI PENSIUN</h6>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    ...
                    <label for="inputAddress">Boks Penyimpanan</label>

                    <?php if($dokumen['penyimpanan_pensiun']==''){?>

                        <button class="btn btn-block btn-danger" disabled="" href="" ><I class="fa fa-info-circle"></i> PENYIMPANAN BELUM DISET</button>

                    <?php } else{?>

                        <input type="text" readonly="" value="Boks <?= $dokumen['penyimpanan_pensiun'];?>" class="form-control d_lokasi" readonly="" required="">  
              ...
              <?php if($dkm_p['status']=='dipinjam'){?>
                ...
                <div class="alert alert-danger mt-2" role="alert"> <strong><i class="fa fa-info-circle"></i> ARSIP PEGAWAI INI DALAM PEMINJAMAN ! </strong></div>
