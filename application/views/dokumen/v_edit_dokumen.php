...
<div class="container-fluid">
          ...
          <div class="card shadow mb-4">
              <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"><I class="fa fa-book"></i> EDIT DATA DOKUMEN PEGAWAI</h6>
               </div>
                <div class="card-body">
                ...
                <div class="row">
                    ...
                    <h6 class="m-0 font-weight-bold text-primary"><I class="fa fa-book"></i> DATA PENYIMPANAN</h6><br>
                         ...
                         <option value="<?= $dokumen['rak'];?>">Rak <?= $dokumen['rak'];?></option>
                         ...
                         <option value="<?= $dokumen['box'];?>">Block <?= $dokumen['box'];?></option>
                         ...
                         <option value="<?= $dokumen['definitif'];?>"><?= $dokumen['definitif'];?></option>
                         <?php for($i = 1; $i <= 10; $i++) { ?>
